...
function render_title( array $args = [] ) {
	...
	return apply_filters( 'alpha/display/title', $args['before'] . $html . $args['after'] );
}
...
function render_permalink( array $args = [] ) {
	...
	return apply_filters( 'alpha/display/permalink', $args['before'] . $html . $args['after'] );
}
...
function render_author( array $args = [] ) {
	...
	return apply_filters( 'alpha/display/author', $args['before'] . $html . $args['after'] );
}
...
function render_date( array $args = [] ) {
	...
	return apply_filters( 'alpha/display/date', $args['before'] . $html . $args['after'] );
}
...
function render_comments_link( array $args = [] ) {
	...
	return apply_filters( 'alpha/display/comments/link', $args['before'] . $html . $args['after'] );
}
...
function render_categories( array $args = [] ) {
	...
	return apply_filters( 'alpha/display/categories', $html );
}
...
function render_tags( array $args = [] ) {
	...
	return apply_filters( 'alpha/display/tags', $html );
}
